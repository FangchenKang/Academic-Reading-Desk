...
面向政治学、公共管理与社会科学研究者的英文学术精读工作台。用户可以粘贴英文论文段落，查看学科核心术语、学术表达词汇、重点句式、双语对照与自动笔记，并体验本地记录、个人词库和 GitHub 同步入口。

## 功能

- 桌面端横屏工作台：首页包含原文输入、学科标签、阅读模式切换和 AI 解析结果区。
- Mock 兜底结果：未配置 AI Key 时也能完整预览核心术语、学术表达词汇、句式、双语翻译和自动笔记。
